 ...
 * JupyterLab Extension to connect to Data Sources. 
 */
export class Connectors extends React.Component<IProps, IState> {
  state = { filter: '' };
  input: Element = null;
  timer: number = 0;
    ...
    return (
      <div style={{
        ...
        <div className="ms-slideDownIn20">
          <div className="ms-font-su">Connectors</div>
          <PrimaryButton>Add Connector</PrimaryButton>
          <Slider
            label='Basic example:'
            min={ 1 }
            max={ 3 }
