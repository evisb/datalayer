...
./node_modules/.bin/uglifyjs dist/@datalayer/ui.js -o dist/@datalayer/ui.min.js -c -m
...
# cp dist/@datalayer/ui.js $TARGET_FOLDER/dist/@datalayer
cp dist/@datalayer/ui.min.js $TARGET_FOLDER/dist/@datalayer
