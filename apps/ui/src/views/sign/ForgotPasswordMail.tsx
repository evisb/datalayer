...
export default class ForgotPassswordMail extends React.Component<any, any> {
  ...
  public render() {
    return (
      <div className='ms-fadeIn500  dla-padding20'>
        <div className='ms-fontSize-xxl'>If the account exists, we have sent you a mail to its owner</div>
